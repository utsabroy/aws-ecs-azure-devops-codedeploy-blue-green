...
export class EcsServiceAlarms extends Construct {
    ...
    constructor(scope: Construct, id: string, props: EcsServiceAlarmsProps = {}) {
        ...
        const blueGroupUnhealthyHostAlarm = this.createAlarm('blueGroupUnhealthyHostAlarmId', blueUnhealthyHostMetric, 'blue', 'UnhealthyHost', 2);
        const blueGroup5xxAlarm = this.createAlarm('blueGroup5xxAlarmId', blue5xxMetric, 'blue', '5xx', 1);
        const greenGroupUnhealthyHostAlarm = this.createAlarm('greenGroupUnhealthyHostAlarmId', greenUnhealthyHostMetric, 'green', 'UnhealthyHost', 2);
        const greenGroup5xxAlarm = this.createAlarm('greenGroup5xxAlarmId', green5xxMetric, 'green', '5xx', 1);
    ...
    private createAlarm(id: string, metric: Metric, targetGroupName: string, errorType: string, evaluationPeriods: number) {
